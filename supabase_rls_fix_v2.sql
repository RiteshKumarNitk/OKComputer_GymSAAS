-- ===================================================================
-- RLS FIX V2 (Anti-Recursion)
-- ===================================================================

-- 1. Create Security Definer Functions to bypass RLS for role/tenant checks
-- These functions run with owner privileges, avoiding infinite recursion
-- when policies on users_profile try to query users_profile.
...
-- ===================================================================
-- 4. FIX USER ROLE (Promote to Gym Owner)
-- ===================================================================
-- This will promote the most recently created user to gym_owner
-- so you can access the management dashboard.
