...
import { Plus, Dumbbell, Users, Zap } from "lucide-react"
                ...
                <Dialog open={isDialogOpen} onOpenChange={(open) => {
                    ...
                    <DialogContent>
                        <DialogHeader>
                            ...
                            <DialogDescription>Define what your gym offers.</DialogDescription>
                        </DialogHeader>
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div className="space-y-2">
                                <Label htmlFor="name">Service Name</Label>
                                <Input id="name" name="name" defaultValue={editingService?.name} required placeholder="e.g. Zumba Class" />
                            </div>
                            <div className="space-y-2">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input id="capacity" name="capacity" type="number" defaultValue={editingService?.capacity || ""} placeholder="Max participants" />
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="description">Description</Label>
                                <Input id="description" name="description" defaultValue={editingService?.description || ""} placeholder="Brief description" />
                            </div>
                            <DialogFooter>
                            ...
                            {services?.map((service) => (
                                <TableRow key={service.id}>
                                    ...
                                    <TableCell className="text-right space-x-2">
                                        ...
                                        <Button variant="ghost" size="sm" className="text-destructive" onClick={() => handleDelete(service.id)}>Delete</Button>
                                    </TableCell>
                                </TableRow>
                            ))}
                            {services?.length === 0 && (
